              ...
              children: [
                Row(
                  children: [
                    ...
                    Text('Color' , style: TextStyle(color: Color.fromRGBO(54, 52, 49, 1), fontWeight: FontWeight.w500, fontSize: 16),),
                  ],
                )
              ],
            ),
              ...
              children: [
                Row(
                  children: [
                    ...
                    Text('About' , style: TextStyle(color: Color.fromRGBO(54, 52, 49, 1), fontWeight: FontWeight.w700, fontSize: 16),),
                  ],
                )
              ],
            ),
              ...
              children: [
                Row(
                  children: [
                    ...
                    Text('Macenus corpus magna vitae convallis congue' ,
                     style: 
                     TextStyle(color: Color.fromRGBO(54, 52, 49, 1), 
